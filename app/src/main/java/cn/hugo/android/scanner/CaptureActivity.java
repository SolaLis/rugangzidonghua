...
//		viewfinderView.drawResultBitmap(barcode);
		...
		if("模型1".equals(ResultParser.parseResult(rawResult).toString())){
			QRApplication.state=0;
		}else if("模型2".equals(ResultParser.parseResult(rawResult).toString())){
			QRApplication.state=1;
		}

		Intent intent = new Intent(CaptureActivity.this, PlayActivity.class);
